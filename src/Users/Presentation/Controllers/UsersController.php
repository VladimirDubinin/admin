...
use App\Users\Application\Services\UserExcelService;
use App\Users\Domain\Filters\UserFilter;
use App\Users\Domain\Forms\UserForm;
...
class UsersController extends Controller
{
    ...
    public function download(UserFilter $filter): void
    {
        $users = User::filter($filter)->get();
        $this->excelService->setItems($users)->export();
    }
}
